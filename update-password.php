			...
			<div class="row">
				...
				<div class="account-wrapper">
					<div class="col-md-12 col-sm-12 create-new-account">
	            		...
	            		<a style="float:right;" href="login.php">Already Have Account ?</a>
	            </div>

				<form method="post" action="handlers/registration/update-account.php" name="register">
					<div class="form-group">
				    	<label class="info-title" for="exampleInputEmail2">Email Address <span>*</span></label>
				    	<input type="email" name="user_name" class="form-control unicase-form-control text-input" id="exampleInputEmail2" 
						required placeholder="email@example.com"  value="<?php echo $user_name ?>" readonly>
				  	</div>
			        <div class="form-group">
					    <label class="info-title" for="exampleInputEmail1"> Full Name <span>*</span></label>
					    <input type="text" name="full_name" class="form-control unicase-form-control text-input" id="exampleInputEmail1" 
						required placeholder="LastName OtherNames" value="<?php echo $full_name ?>">
					</div>
			        <div class="form-group">
