<?php
    ...
    $location_state = $_GET['location'];
    $details = $location->getSingleLocationTown($location_state);
?>
        ...
        <div class="row pt-2 pb-2">
            <div class="col-sm-9">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="edit-shipping-location.php?location=<>php echo $location_state ?>">Edit Shipping Location</a></li>
                    <li class="breadcrumb-item"><a href="shipping-location.php">Add Shipping Location</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Editing Shipping Location</li>
                </ol>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header"><i class="fa fa-table"></i> Please Fill The Below Form To Update Shipping Location</div>
                    <div class="card-body">
                        <form action="update_location.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    ...
                                    placeholder="Enter The Shipping Location " value="<?php echo $location_state ?>">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    placeholder="Enter The Charges" value=<?php echo $details['charge']; ?>>
                                    <span style="color: red">** This Field is Required **</span>     
                                </div>
                                <input type="hidden" name="location_id" value="<?php echo $details['id'] ?>">
                                <input type="hidden" name="prev_name" value="<?php echo $location_state ?>">
                                
                                <div class="col-sm-12" align="center">
                                    <button type="submit" class="btn btn-success btn-lg btn-block" name="add-location">UPDATE THE LOCATION </button>
                                </div>   
                            </div>
                        </form>
                    </div>
