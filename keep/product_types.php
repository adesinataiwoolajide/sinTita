<?php 
    ...
    $seth = $type->getSingleTypeName($type_name);
    echo $type_id = $seth['type_id'];
    $demo = $type->getSingleId($type_id);
            ...
            <div class="row">
                <div class="col-xs-12">
                    <ul>
                        ...
                        <li class=""> <a title="Go to product_types.php?type_name=<?php echo $type_name ?> Product" 
                            href="product_types.php?type_name=<?php echo $type_name ?>">
                            <?php echo $type_name ?> Products </a><span>&raquo;

                            </span>
                        </li>
                        <li><strong>List of <?php echo $type_name ?> Product</strong></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    if($totalItems == 0){ ?>
                        ...
                        <div class="shop-inner">
                            <div class="page-title">
                                <h2><?php echo $type_name ?> Products</h2>
                            </div>
                            ...
                            <div class="pagination-area">
                                ...
                                if($totalItems > 0){ ?>
                                    <ul>
                                        <?php $b = $page - 1;
                                        if($page != 1){ ?>
                                            <li><a href="product_types.php?type_name=<?php echo $type_name ?>&&page=<?php echo $page - 1?>" class="active">
