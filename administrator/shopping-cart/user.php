                        ...
                        <form action="process-user.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-sm-12" align="center">
                                    <button type="submit" class="btn btn-success btn-lg btn-block" name="add-user">ADD THE USER </button>
                                </div>
								...
								<table id="default-datatable" class="table table-bordered">
					                ...
					                <tbody>
										...
										foreach($register->viewAllUsers() as $listUser) {
                                            $user_name = $listUser['user_name'];
											?>
											<tr>
												<td><?php echo $number; ?>
													<a href="delete-user.php?user_name=<?php echo $user_name ?>" class="btn btn-danger" onclick="return(confirmToDelete());"><i class="fa fa-trash-o"></i></a>
													<a href="edit-user.php?user_name=<?php echo $user_name ?>" class="btn btn-success" onclick="return(confirmToEdit());"><i class="fa fa-pencil"></i></a>
												</td>
