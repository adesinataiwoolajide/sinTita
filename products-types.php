<?php
    ...
    $cateDetails = $type->getSingleTypeName($type_name);
    $genre_id = $cateDetails['type_id'];
    $totalItems =  count($product->getSingleGenreProduct($genre_id));
    $itemsPerPage = 20;
    $page = isset($_GET['page']) ? ($_GET['page']) : 1;
    $start = $page > 1 ? ($page * $itemsPerPage) - $itemsPerPage : 0;
    $totalPages = ceil($totalItems / $itemsPerPage);
    $seeProdcut = $product->getSingleCategoryProductType($genre_id, $start, $itemsPerPage);
?>
                ...
                if($totalItems == 0){ ?>
                    <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
                        <div class="more-info-tab clearfix ">
                            <h3><p style="color: red" align="center">No Product is Found for <?php echo $type_name ?> Types</p></h3>
                        </div>
                    </div>  <?php 
                } else{ ?>         
                    <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
                        <div class="more-info-tab clearfix ">
                            <h3 class="new-product-title pull-left">Products in <?php echo $type_name ?> Types </h3>
                                    ...
                                    if($totalItems > 3){ ?>
                                        <ul class="list-inline list-unstyled">
                                            ...
                                            <?php if($page != $totalPages){ ?>
                                                  <li class="next"><a href="products-types.php?type_name=<?php echo $type_name?>s&&page=<?php echo $page + 1?>"><i class="fa fa-angle-right"></i></a></li>
                                            <?php } ?>                                        
                                        </ul><?php 
                                    } ?>
                                    <!-- /.list-inline --> 
