  ...
  <div class="footer-bottom">
    <div class="container">
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-6 col-md-3">
          <div class="module-heading">
            <h4 class="module-title">Customer Hot Line</h4>
          </div>
          <!-- /.module-heading -->
        ...
        <div class="col-xs-12 col-sm-6 col-md-3">
          ...
          <div class="module-body">
            <ul class='list-unstyled'>
              <li class="first"><a href="./" title="About us">Products</a></li>
              <li><a href="shop.php" title="Blog">Shop</a></li>
    ...
    <div class="container">
      ...
      <div class="col-xs-12 col-sm-6 no-padding">
        <div class="clearfix payment-methods">
          <ul>
            <li><img src="style/images/payments/1.png" alt=""></li>
            <li><img src="style/images/payments/1.png" alt=""></li>
            <li><img src="style/images/payments/1.png" alt=""></li>
            <li><img src="style/images/payments/1.png" alt=""></li>
            <li><img src="style/images/payments/1.png" alt=""></li>
...
<script src="style/js/bootstrap-slider.min.js"></script> 
<script src="style/js/jquery.rateit.min.js"></script> 
