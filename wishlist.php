                ...
                <div class="col-xs-12">
                    <ul>
                        ...
                        <li class=""> <a title="Go to Wish List" 
                            ...
                            <?php echo $_SESSION['name'] ?> Wishlist </a><span>&raquo;

                            </span>
                        </li>
                        <li><strong>List of <?php echo $_SESSION['name'] ?> Wish List</strong></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                    ...
                    if($totalItems == 0){ ?>
                        <div class="col-main col-sm-9 col-xs-9" align="center"> <h3>
                            <p style="color: red" align="center"><?php echo $_SESSION['name'] ?> Your Wish List is Empty</p>
                            </h3> 
                        </div><?php
                    }else{ ?>
                        ...
                        <div class="shop-inner">
                            <div class="page-title">
                                <h2><?php echo $_SESSION['name'] ?> Wish List</h2>
                            </div>
                            
                            <div class="product-grid-area">
                                <ul class="products-grid"><?php
                                    foreach(gettingWishList($reg_number) as $list){
                                        $slug = $list['slug'];
