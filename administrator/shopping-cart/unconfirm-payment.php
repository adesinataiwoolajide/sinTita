<?php
    ...
    $total = count($order->unconfirmPayment());
?>
        ...
        <div class="row pt-2 pb-2">
            <div class="col-sm-9">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="cancel-payment.php">Un Confirm Pyment</a></li>
                    <li class="breadcrumb-item"><a href="confirmed-payment.php">Confirmed Payment</a></li>
	    	...
	    	<div class="col-lg-12">
	          	<div class="card"><?php
	          		if($total==0){ ?>
						...
						<div class="card-header"><i class="fa fa-table"></i> List of Un Confirm Payment Order</div>
						<div class="card-body">
							<div class="table-responsive">
                                <table id="default-datatable" class="table table-bordered">
									...
									<tbody>
										<?php $number =1; 
										foreach($order->unconfirmPayment() as $listOrder) {
											...
											<tr>
												<td><?php echo $number; ?>
                                                    <a href="process-payment.php?action=<?php echo 'Confirm' ?>&&order_number=<?php echo $orderId ?>&&customer_number=<?php echo $customer_id ?>" 
                                                    class="btn btn-danger">
                                                        <i class="fa fa-cogs">Confirm</i>
                                                    </a>
                                                </a>
                                                </td><?php
                                                ...
                                                <td><p style="color: red"> Un Confirmed</p></td>
