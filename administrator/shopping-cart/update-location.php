...
try{
    if(isset($_POST['add-location'])){
        ...
        if($location->updateLocation($loca, $charge, $location_id)){
            $action ="Updated Location Name From $prev_name to $loca";
            $his = $all_purpose->getUserDetailsandAddActivity($email, $action);
            $_SESSION['success'] = "You Have Updated Location Name From $prev_name to $loca Successfully";
        ...
        $_SESSION['error'] = "Please Fill The Form Below To Update The Location Details";
        $all_purpose->redirect($return);
    }
