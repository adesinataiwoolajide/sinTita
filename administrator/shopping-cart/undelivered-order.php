<?php
    ...
    $total = count($order->unDelivCustomerOrder());
        ...
        <div class="row pt-2 pb-2">
            <div class="col-sm-9">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="deliver-order.php">Un Deliver Order</a></li>
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Customer Un Delivered Order</li>
                </ol>
            </div>
        </div>
	          	...
	          	<div class="card"><?php
	          		if($total==0){ ?>
                        <div class="card-header" align="center" style="color: red">
                            <i class="fa fa-table"></i> No Recent Undelivery Order Was Found
						</div><?php 
					}else{ ?>
						...
						<div class="card-body">
							<div class="table-responsive">
                                <table id="default-datatable" class="table table-bordered">
									...
									<tbody>
										<?php $number =1; 
										foreach($order->unDelivCustomerOrder() as $listOrder) {
											...
											<tr>
                                                ...
                                                <td><p style="color: red">Un Delivered</p></td>
