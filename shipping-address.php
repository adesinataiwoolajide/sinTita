	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				<li><a href="./">Home</a></li>
				<li><a href="shipping-address.php"> Shipping </a></li>
		        ...
		        if(isset($_SESSION['cart'])){ 
                    ...
                    if($count>0){ ?> ?>
		                <div class="col-lg-6">
							<div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
			                    <div class="more-info-tab clearfix ">
		                            ...
		                            <a href="shop.php" class="btn btn-block btn-sm btn-primary">Continue Shopping</a>   
								</div>	
			                </div>
			            </div>
						<div class="col-lg-6">
			        	...
			        	<div class="col-lg-12">
							<div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
			                    <div class="more-info-tab clearfix ">
			                        <a href="shop.php" class="btn btn-block btn-sm btn-danger">Continue Shopping</a>  
			                    </div>
			                </div>
