...
<div class="content-wrapper">
    <div class="container-fluid">
            ...
            <div class="col-sm-9">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="./">Home</a></li>
                     <li class="breadcrumb-item"><a href="edit-manufacturer.php?manufacturer_name=<?php echo $publisher_name ?>&&manufacturer_id=<?php echo $publisher_id ?>">Edit Manufacturer</a></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header"><i class="fa fa-table"></i> Please Fill The Below Form To Update Manufacturer Details</div>
                    <div class="card-body">
                        <form action="update-manufacturer.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row ">
                                <div class="col-sm-6">
                                    ...
                                    placeholder="Enter The Manufacturer Name" value="<?php echo $publisher_name ?>">
                                    <span style="color: red">** This Field is Required **</span>     
                                </div>
                                <div class="col-sm-6">
                                	<label for="input-6">Change Manufacturer Logo </label>
                                ...
                                <input type="hidden" name="prev_name" value="<?php echo $publisher_name ?>">


                                <div class="col-sm-12" align="center">
                                    <button type="submit" class="btn btn-success btn-lg btn-block" name="add-publisher">UPDATE THE MANUFACTURER </button>
                                </div>
		              				...
		              				<table id="example" class="table table-bordered">
						                ...
						                <tbody>
											...
											foreach($publisher->getAllPublisher() as $listPublisher) {
												$publisherid = $listPublisher['publisher_id'];
												$publishername=$listPublisher['publisher_name'] ?>
												<tr>
													<td><?php echo $number; ?>
														...
														<a href="edit-manufacturer.php?manufacturer_name=<?php echo $publishername ?>&&manufacturer_id=<?php echo $publisherid ?>" class="btn btn-success" onclick="return(confirmToEdit());"><i class="fa fa-pencil"></i></a>
													</td>
