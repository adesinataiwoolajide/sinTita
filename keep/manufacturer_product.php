            ...
            <div class="row">
                <div class="col-xs-12">
                    <ul>
                        ...
                        <li class=""> <a title="Go to manufacturer_products.php?manufacturer_name=<?php echo $publisher_name ?> Product" 
                            href="manufacturer_products.php?manufacturer_name=<?php echo $publisher_name ?>"><?php echo $publisher_name ?> Products </a><span>&raquo;

                            </span>
                        </li>
                        <li><strong>List of <?php echo $publisher_name ?> Product</strong></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    if($totalItems == 0){ ?>
                        ...
                        <div class="shop-inner">
                            <div class="page-title">
                                <h2><?php echo $publisher_name ?> Products</h2>
                            </div>
                            ...
                            <div class="pagination-area">
                                ...
                                if($totalItems > 0){ ?>
                                    <ul>
                                        <?php $b = $page - 1;
                                        if($page != 1){ ?>
                                            <li><a href="manufacturer_product.php?manufacturer_name=<?php echo $publisher_name ?>&&page=<?php echo $page - 1?>" class="active">
