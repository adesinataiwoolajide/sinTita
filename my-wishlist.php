<?php
    ...
    $seeWishList = $register->gettingWishList($reg_number);
?>
                    ...
                    if($totalItems == 0){ ?>
                        ...
                        <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
                            <div class="more-info-tab clearfix ">
                                <h3 class="new-product-title pull-center" style="color:red" align="center"><?php echo $_SESSION['name'] ?> Your Wish List is Empty</h3> 
                            </div>
                        </div><?php
                    }else{ ?>
                         <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
                            <div class="more-info-tab clearfix ">
                                <h3 class="new-product-title pull-left" align="center"><?php echo $_SESSION['name'] ?> Wish List </h3>
                                                                    ...
                                                                    <div class="action">
                                                                        <ul class="list-unstyled">
                                                                            <li class="lnk wishlist"> 
                                                                                <a data-toggle="tooltip" class="add-to-cart" href="handlers/registration/addit.php?slug=<?php echo $slug?>&&action=<?php echo 'Delete Wishlist'?>&&list_id=<?php echo $index['list_id'] ?>" title="Delete Wishlist"> <i class="icon fa fa-trash-o"></i> </a> 
                                                                            </li>
